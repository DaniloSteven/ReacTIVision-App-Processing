...
public class TuioProcessing implements TuioListener {
  ...
  public TuioProcessing(PApplet parent, int port) {
    ...
    try { 
      refresh = parent.getClass().getMethod("refresh", new Class[] { TuioTime.class } );
    }
    catch (Exception e) { 
    ...
    try { 
      addTuioObject = parent.getClass().getMethod("addTuioObject", new Class[] { TuioObject.class });
    }
    catch (Exception e) { 
    ...
    try { 
      removeTuioObject = parent.getClass().getMethod("removeTuioObject", new Class[] { TuioObject.class });
    }
    catch (Exception e) { 
    ...
    try { 
      updateTuioObject = parent.getClass().getMethod("updateTuioObject", new Class[] { TuioObject.class });
    }
    catch (Exception e) { 
    ...
    try { 
      addTuioCursor = parent.getClass().getMethod("addTuioCursor", new Class[] { TuioCursor.class });
    }
    catch (Exception e) { 
    ...
    try { 
      removeTuioCursor = parent.getClass().getMethod("removeTuioCursor", new Class[] { TuioCursor.class });
    }
    catch (Exception e) { 
    ...
    try { 
      updateTuioCursor = parent.getClass().getMethod("updateTuioCursor", new Class[] { TuioCursor.class });
    }
    catch (Exception e) { 
    ...
    try { 
      addTuioBlob = parent.getClass().getMethod("addTuioBlob", new Class[] { TuioBlob.class });
    }
    catch (Exception e) { 
    ...
    try { 
      removeTuioBlob = parent.getClass().getMethod("removeTuioBlob", new Class[] { TuioBlob.class });
    }
    catch (Exception e) { 
    ...
    try { 
      updateTuioBlob = parent.getClass().getMethod("updateTuioBlob", new Class[] { TuioBlob.class });
    }
    catch (Exception e) { 
